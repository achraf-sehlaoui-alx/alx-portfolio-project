        ...
        try {
            ...
            if (!$user) {
                ...
                try {
                    ...
                    $stmt->execute(array($nom, $prenom, $date, $telephone, $adresse, $ville, $email, $password, $type, $sexe));
                ...
                if (isset($_POST["inscripRecruteur"])) {
                    header("Location: ../recruteur/Accée/Inscr.html?message=Email%20existe%20déjà");
                    exit();
                } else if(isset($_POST["inscripCandidats"])) {
                    header("Location: ../candidats/Accée/Inscr.html?message=Email%20existe%20déjà");
                    exit();
                }
            }
        } catch (PDOException $e) {
